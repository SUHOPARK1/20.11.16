...
// 정적 할달의 경우, 우리가 크기를 직접 지정해놓았기 때문에
...
// 정적할달일 경우,
// 배열이 꽉 찼을 경우
// Ex05 : 새로운 정보를 더 이상 입력할 수 없음
// Ex06 : 기존 정보를 날려야 새로운 정보를 입력할 수 있음
// 이란 단점을 맞이하게 된다.

// 따라서, 크기에 자유로운 배열을 만들려고 하면
// 복잡한 과정을 통해서 크기를 자유재재로 다루는
// 배열이 되어야 한다!

// 이렇게, 크기가 자유로운 배열을 우리가 '동적 할당한다' 라고 한다.
...
public class Ex06DynamicAlloc {
    public static void main(String[] args) {
        ...
        System.out.println("잘못된 인덱스 삭제 후 array.lenght: " + array.length);
