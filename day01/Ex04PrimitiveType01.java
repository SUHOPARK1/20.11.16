...
// 기본형 데이터타입 01
// 정수형
// 정수란 나눠 떨어지는 수이다. 즉 실수가 존재하지 않는 숫자들이다.
// 정수형 데이터 타입에는
// 4가지 종류가 있다.
// byte : 8비트
// short : 16비트
...
// 2진법이란?
// 우리가 일상생활에서 사용하는 숫자체계는 10진법이다.
// 10진법은 한 자리에 10가지의 숫자가 들어갈 수 있고, 각 자리가 10의 제곱을 뜻한다.
// 에를 들어 37801 이라는 숫자는
// 30000 + 7000 + 800 + 0 + 1 로 풀어 쓸 수 있다.
...
public class Ex04PrimitiveType01 {
    public static void main(String[] args) {
        ...
        // 에러가 난다.
        int myInt = 150;
        // 위 코드는 인트의 범위에 속하는 150이라는 숫자를 할당했기 때문에
        // 에러가 나지 않는 코드이다.
