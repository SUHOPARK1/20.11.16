...
// && || !
// &&: AMD 연산자. 2개의 boolean 값이 모든 true일 때에만 true가 나온다
...
//     만약 앞의 boolean이 true일 경우, 뒤의 boolean은 아에 연산 혹은 계산 하지 않고
//     곧장 true가 결과값으로 나온다.
// !: NOT 연산자. 1개의 boolean값을 반대값으로 뒤집는다.
//    즉 true는 false로, false는 true로 바뀐다.
...
public class Ex02operator04 {
    public static void main(String[] args) {
        ...
        System.out.println("password.equals(usedPassword): "+password.equals(userPassword));
        System.out.println("!password.equals(usedPassword): "+!password.equals(userPassword));
